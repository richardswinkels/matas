<template>
    <form @submit.prevent="storeComponent(this.component)">
        <div>
            ...
            <input v-model="this.component.name" id="name" type="text" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm text-sm mr-2 w-full">
        ...
        <div class="mt-4">
            ...
            <select v-model="this.component.manufacturer_id" id="manufacturer" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm text-sm mr-2 w-full">
        ...
        <div class="mt-4">
            ...
            <input v-model="this.component.type" id="type" type="text" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm text-sm mr-2 w-full">
            <div class="text-red-600 text-sm mt-1">
        ...
        <div class="mt-4">
            ...
            <input v-model="this.component.price" id="price" type="number" min="0" step="0.01" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm text-sm mr-2 w-full">
            <div class="text-red-600 text-sm mt-1">
